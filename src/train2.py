...
from utils.common import AverageMeter, set_seed, load_yaml, write_yaml
...
class Trainer:
    def __init__(self, config):
        ...
        self.model = APSDCP_Refine(pretrained_apsdcp_path=config["stage1_path"])
    ...
    def update_valid_log(self, step, psnr, J):
